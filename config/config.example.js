...
const config = {
  ...
  imageRelay: {
    upstreamHealthCheckTimeoutMs:
      parseInt(process.env.IMAGE_UPSTREAM_HEALTHCHECK_TIMEOUT_MS) || 5000,
    totalHealthCheckTimeoutMs: parseInt(process.env.IMAGE_TOTAL_HEALTHCHECK_TIMEOUT_MS) || 30000
  },
